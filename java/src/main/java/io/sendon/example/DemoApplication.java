...
import io.sendon.example.contacts.ContactsDivider;
import io.sendon.example.contacts.ContactsGetBlocklist;
import io.sendon.example.kakao.KakaoDivider;
import io.sendon.example.kakao.channel.KakaoGetSendProfiles;
import io.sendon.example.kakao.channel.KakaoRegisterChannel;
...
import io.sendon.example.payment.PaymentGetHistory;
import io.sendon.example.point.PointDivider;
import io.sendon.example.point.PointGetCost;
import io.sendon.example.point.PointGetPoint;
import io.sendon.example.sender.SenderDivider;
import io.sendon.example.sender.SenderGetNumbers;
import io.sendon.example.sms.SmsDivider;
